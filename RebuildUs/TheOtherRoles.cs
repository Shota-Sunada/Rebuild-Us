...
public static class Swapper
{
    ...
    public static Sprite getCheckSprite()
    {
        ...
        spriteCheck = Helpers.loadSpriteFromResources("RebuildUs.Resources.SwapperCheck.png", 150f);
        return spriteCheck;
    }
...
public static class Vampire
{
    ...
    {
        if (buttonSprite) return buttonSprite;
        buttonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.VampireButton.png", 115f);
        return buttonSprite;
    }
    ...
    public static Sprite getGarlicButtonSprite()
    {
        ...
        garlicButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.GarlicButton.png", 115f);
...
public static class Snitch
{
    ...
    public static Dictionary<byte, byte> playerRoomMap = [];
...
public static class SecurityGuard
{
    ...
    public static Sprite getCloseVentButtonSprite()
    {
        ...
        closeVentButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.CloseVentButton.png", 115f);
    ...
    public static Sprite getPlaceCameraButtonSprite()
    {
        ...
        placeCameraButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.PlaceCameraButton.png", 115f);
    ...
    public static Sprite getAnimatedVentSealedSprite()
    {
        ...
        animatedVentSealedSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.AnimatedVentSealed.png", ppu);
    ...
    public static Sprite getStaticVentSealedSprite()
    {
        ...
        staticVentSealedSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.StaticVentSealed.png", 160f);
    ...
    public static Sprite getFungleVentSealedSprite()
    {
        ...
        fungleVentSealedSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.FungleVentSealed.png", 160f);
    ...
    public static Sprite getSubmergedCentralUpperSealedSprite()
    {
        ...
        submergedCentralUpperVentSealedSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.CentralUpperBlocked.png", 145f);
    ...
    public static Sprite getSubmergedCentralLowerSealedSprite()
    {
        ...
        submergedCentralLowerVentSealedSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.CentralLowerBlocked.png", 145f);
...
public static class Medium
{
    ...
    public static Sprite getQuestionSprite()
    {
        ...
        question = Helpers.loadSpriteFromResources("RebuildUs.Resources.MediumButton.png", 115f);
        return question;
    }
...
public static class Pursuer
{
    ...
    public static Sprite getTargetSprite()
    {
        ...
        blank = Helpers.loadSpriteFromResources("RebuildUs.Resources.PursuerButton.png", 115f);
        return blank;
    }
...
public static class Witch
{
    ...
    {
        if (buttonSprite) return buttonSprite;
        buttonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.SpellButton.png", 115f);
        return buttonSprite;
    }
    ...
    public static Sprite getSpelledOverlaySprite()
    {
        ...
        spelledOverlaySprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.SpellButtonMeeting.png", 225f);
...
public static class Ninja
{
    ...
    public static Sprite getMarkButtonSprite()
    {
        ...
        markButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.NinjaMarkButton.png", 115f);
    ...
    public static Sprite getKillButtonSprite()
    {
        ...
        killButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.NinjaAssassinateButton.png", 115f);
...
public static class Trapper
{
    ...
    public static List<byte> playersOnMap = [];
    ...
    public static Sprite getButtonSprite()
    {
        ...
        trapButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.Trapper_Place_Button.png", 115f);
...
public static class Bomber
{
    ...
    {
        if (buttonSprite) return buttonSprite;
        buttonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.Bomb_Button_Plant.png", 115f);
        return buttonSprite;
    }

    public static void clearBomb(bool flag = true)
    {
        RebuildUsPlugin.Instance.Logger.LogDebug("Clearing Bomb!");
        if (bomb != null)
        {
