...
namespace RebuildUs.CustomGameModes
{
    ...
    class PropHunt
    {
        ...
        {
            return Helpers.loadSpriteFromResources($"RebuildUs.Resources.IntroAnimation.intro_{index + 1000}.png", 150f, cache: false);
        }

        public static void updateWhitelistedObjects(bool debug = false)
        {
            string allNames = Helpers.readTextFromResources("RebuildUs.Resources.Txt.Props.txt");
            if (debug)
            {
        ...
        public static void poolablePlayerUpdate()
        {
            if (poolablesBackground == null)
            {
                ...
                if (poolablesBackgroundSprite == null) poolablesBackgroundSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.poolablesBackground.jpg", 200f);
            }
        ...
        public static Sprite getDisguiseButtonSprite()
        {
            ...
            disguiseButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.DisguiseButton.png", 115f);
        ...
        public static Sprite getUnstuckButtonSprite()
        {
            ...
            unstuckButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.UnStuck.png", 115f);
            return unstuckButtonSprite;
        }
        public static Sprite getRevealButtonSprite()
        {
            if (revealButtonSprite) return revealButtonSprite;
            revealButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.Reveal.png", 115f);
        ...
        public static Sprite getInvisButtonSprite()
        {
            ...
            invisButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.InvisButton.png", 115f);
        ...
        public static Sprite getFindButtonSprite()
        {
            ...
            findButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.FindButton.png", 115f);
        ...
        public static Sprite getSpeedboostButtonSprite()
        {
            ...
            speedboostButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.SpeedboostButton.png", 115f);
        ...
        public static GameObject FindClosestDisguiseObject(GameObject origin, float radius, bool verbose = false)
        {
            ...
            try
            {
                ...
                foreach (Collider2D collider in Physics2D.OverlapCircleAll(origin.transform.position, radius))
                {
                    if (verbose)
                    {
                        RebuildUsPlugin.Instance.Logger.LogMessage($"Nearby Object: {collider.gameObject.name}");
                    }
                    bool whiteListed = false;
            ...
            {
                RebuildUsPlugin.Instance.Logger.LogError($"Error in find closest disguise object: {e}");
                return null;
            }
        }
