...
public static class EventUtility
{
    ...
    public static Sprite getKickButtonSprite()
    {
        ...
        kickButtonSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.EventKickButton.png", 115f);
    ...
    {
        //if (!isEnabled || AmongUsClient.Instance.GameState != InnerNet.InnerNetClient.GameStates.Started || RebuildUs.rnd == null || IntroCutscene.Instance) return;
