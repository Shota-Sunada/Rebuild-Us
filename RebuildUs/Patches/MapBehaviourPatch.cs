...
{
    public static Dictionary<Byte, SpriteRenderer> herePoints = [];

    public static Sprite Vent = Helpers.loadSpriteFromResources("RebuildUs.Resources.Vent.png", 150f);

    public static List<List<Vent>> VentNetworks = [];

    public static Dictionary<string, GameObject> mapIcons = [];
