...
public class Portal
{
    ...
    public static Sprite getFgAnimationSprite(int index)
    {
        ...
        if (portalFgAnimationSprites[index] == null)
            portalFgAnimationSprites[index] = (Helpers.loadSpriteFromResources($"RebuildUs.Resources.PortalAnimation.portal_{(index):000}.png", 115f));
    ...
    private static void preloadSprites()
    {
        ...
        portalSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.PortalAnimation.plattform.png", 115f);
    }
