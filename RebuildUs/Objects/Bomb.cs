...
public class Bomb
{
    ...
    public static Sprite getBombSprite()
    {
        ...
        bombSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.Bomb.png", 300f);
        return bombSprite;
    }
    public static Sprite getBackgroundSprite()
    {
        if (backgroundSprite) return backgroundSprite;
        backgroundSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.BombBackground.png", 110f / Bomber.hearRange);
    ...
    public static Sprite getDefuseSprite()
    {
        ...
        defuseSprite = Helpers.loadSpriteFromResources("RebuildUs.Resources.Bomb_Button_Defuse.png", 115f);
        return defuseSprite;
    }
