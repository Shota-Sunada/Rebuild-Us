...
public class BepInExUpdater : MonoBehaviour
{
    ...
    public void Awake()
    {
        RebuildUsPlugin.Instance.Logger.LogMessage("BepInEx Update Required...");
        RebuildUsPlugin.Instance.Logger.LogMessage($"{Paths.BepInExVersion}, {RequiredBepInExVersion} ");
    ...
    {
        Task.Run(() => MessageBox(GetForegroundWindow(), "Required BepInEx update is downloading, please wait...", "Rebuild Us", 0));
